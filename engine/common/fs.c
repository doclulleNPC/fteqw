...
//	{"-warsow",		"warsow",	"FTE-Warsow",			{"basewsw/pak0.pk3"},			NULL,	{"basewsw",						"*ftewsw"},	"Warsow"},
	...
	{"-doom",		"doom",		"FTE-Doom",				{"doom1/doom1.wad","doom1/doom.wad","doom1.wad"},	NULL,	{"doom",	"doom1",	"*fte"},	"Doom"},
	{"-doom2",		"doom2",	"FTE-Doom2",			{"doom2/doom2.wad","doom2/DOOM2.WAD"},	NULL,	{"doom",	"doom2",	"*fte"},	"Doom 2"},
